...
The default configuration hides Shorts, redirects channel pages to `/videos`, prevents timestamp scrolling, and enables grid adjustment. Mixes and watched videos are visible by default.
